        ...
        for ($Y=-2+$playerY; $Y < 3+$playerY; $Y++)
        {
          ...
          if ($X > -1 && $Y > -1 && $X < count($array) && $Y < count($array2))
          {
            ...
            for ($id=1; $id < $playernum+1; $id++)
            {
              ...
              if ($playersx[$id]==$X && $playersy[$id]==$Y)
              {
                ...
                }elseif ($array[$X][$Y]==9)
                {
                  ...
                  echo "<img src='image/furnacing.jpg' alt=''>";
                }elseif ($array[$X][$Y]==4)
                {
            ...
            if ($playerprint == false)
            {
              ...
              {
                echo "<img src='image/iron_ore.jpg' alt=''>";
              }elseif ($array[$X][$Y] == 7)
              {
                echo "<img src='image/redstone_ore.jpg' alt=''>";
              }elseif ($array[$X][$Y] == 8)
              {
                echo "<img src='image/bedrock.jpg' alt=''>";
              }elseif ($array[$X][$Y] == 9)
              {
                echo "<img src='image/furnace_place.jpg' alt=''>";
              }else
              {
                if ($id==$_SESSION["playerid"])
                {
